...
function Carrinho() {
  const { itensCarrinho, limparCarrinho, valorTotal, totalItens } =
    useCarrinho();
        ...
        <Container className="bg-dark text-light mt-4 p-4 rounded shadow-lg bg-opacity-75 w-100">
              ...
              <>
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    <h5>
                      Total de itens:{" "}
                      <span className="text-info">{totalItens}</span>
                    </h5>
                    <h4>
                      Total:{" "}
          ...
          <div>
            <div className="d-flex justify-content-end mt-4">
              ...
              <Button variant="success" disabled={itensCarrinho.length === 0}>
                Finalizar Compra
              </Button>
            </div>
          </div>
